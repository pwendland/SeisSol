...
namespace seissol {
  namespace tensor {
      // DEBUG: CUDA part
      extern unsigned num_elements_in_cluster;
      extern unsigned *device_linspace;
      extern unsigned *device_ones;
      extern unsigned *device_zeros;
    ...
    struct AplusT {
      constexpr static unsigned const Shape[2] = {9, 9};
      constexpr static unsigned const Size = 81;
      static unsigned *stride_ptr;
      constexpr static unsigned const jump_to_next = 0; // false i.e. must not be used
      constexpr static unsigned size() {
        return Size;
      }
    };
    struct I {
      ...
      constexpr static unsigned const jump_to_next = 504;
      static unsigned *stride_ptr;
      constexpr static unsigned size() {
        return Size;
      }
    ...
    struct dQ {
      ...
      constexpr static unsigned const jump_to_next[] = {504, 324, 180, 108, 36, 36};
    ...
    struct fMrT {
      ...
      static unsigned *stride_ptr[4];
      constexpr static unsigned const jump_to_next[] = {0, 0, 0, 0};
      constexpr static unsigned index(unsigned i0) {
        return 1*i0;
      }
      constexpr static unsigned size(unsigned i0) {
    ...
    struct kDivM {
      ...
      constexpr static unsigned const jump_to_next[] = {0, 0, 0};
      constexpr static unsigned index(unsigned i0) {
        return 1*i0;
      }
      constexpr static unsigned size(unsigned i0) {
    ...
    struct kDivMT {
      constexpr static unsigned const Shape[][2] = {{56, 56}, {56, 56}, {56, 56}};
      constexpr static unsigned const Size[] = {1908, 1944, 1980};
      constexpr static unsigned const jump_to_next[] = {0, 0, 0};
      constexpr static unsigned index(unsigned i0) {
        return 1*i0;
      }
    ...
    struct rDivM {
      ...
      static unsigned *stride_ptr[4];
      constexpr static unsigned const jump_to_next[] = {0, 0, 0, 0}; // false i.e. must not be used
      constexpr static unsigned index(unsigned i0) {
        return 1*i0;
      }
      constexpr static unsigned size(unsigned i0) {
    ...
    struct star {
      ...
      constexpr static unsigned const jump_to_next[] = {243, 243, 243};
      constexpr static unsigned index(unsigned i0) {
        return 1*i0;
      }
      constexpr static unsigned size(unsigned i0) {
